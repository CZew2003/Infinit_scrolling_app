...
class _$CreateReviewStartImpl implements CreateReviewStart {
  const _$CreateReviewStartImpl({required this.imageId, required this.text});
  ...
  @override
  String toString() {
    return 'CreateReview(imageId: $imageId, text: $text)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, imageId, text);
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(imageId, text);
  }
...
abstract class CreateReviewStart implements CreateReview {
  const factory CreateReviewStart({required final String imageId, required final String text}) =
