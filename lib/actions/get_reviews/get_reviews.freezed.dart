...
class _$GetReviewsStartImpl implements GetReviewsStart {
  const _$GetReviewsStartImpl({required this.imageId});
  ...
  @override
  String toString() {
    return 'GetReviews(imageId: $imageId)';
  }
...
abstract class GetReviewsStart implements GetReviews {
  const factory GetReviewsStart({required final String imageId}) = _$GetReviewsStartImpl;
