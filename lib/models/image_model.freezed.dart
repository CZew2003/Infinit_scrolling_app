...
class _$ImageModel$Impl implements ImageModel$ {
  ...
  @override
  String toString() {
    return 'ImageModel(description: $description, createdAt: $createdAt, urls: $urls, likes: $likes, user: $user)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, description, createdAt, urls, likes, user);
